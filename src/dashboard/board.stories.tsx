...
function BoardController() {
  ...
  function addPin(){
    const nextIndex = (Object.values(pins).length + 1).toString(); 
    pins[nextIndex] = { id: nextIndex, body: '', pitch: '123', yaw: '123' };
    setPins(pins);
  }
  ...
  return  <React.Fragment>
    ...
    <Board boardJson={{id: 'tech', pins}}  updatePin={updatePin} />
  </React.Fragment>
